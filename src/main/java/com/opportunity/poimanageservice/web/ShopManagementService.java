...
public final class ShopManagementService {
  ...
  @ResponseBody
  public com.opportunity.poimanageservice.model.dto.Error handleResourceDoesNotExistException(
      ResourceDoesNotExistException error) {

    return new com.opportunity.poimanageservice.model.dto.Error("Not found: " + error.getMessage(), "Not found: " +
